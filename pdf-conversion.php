                ...
                <div class="flex flex-col md:flex-row items-center">
                    <div class="md:w-1/2 mb-8 md:mb-0">
                        ...
                        <p class="text-xl text-gray-300 mb-8 max-w-lg">
                            The ultimate PDF conversion tool that handles all your document needs securely in your
                            browser. No
                    ...
                    <div class="md:w-1/2 flex justify-center">
                        <div class="relative">
                            ...
                            <svg class="w-80 h-80 neon-glow" viewBox="0 0 120 120" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <rect x="15" y="10" width="90" height="100" rx="4" fill="#1E293B" stroke="#818CF8"
                                    stroke-width="2" />
                                ...
                                <g class="animate-pulse">
                                    <path d="M90 65L85 60L80 65" stroke="#10B981" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M85 60V75" stroke="#10B981" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </g>
                                <circle cx="85" cy="40" r="10" fill="#6366F1" opacity="0.2" stroke="#6366F1"
                                    stroke-width="1" />
                            ...
                            <div
                                class="absolute -right-6 top-5 bg-blue-600 rounded-full p-2 shadow-lg animate-bounce neon-blue">
        ...
        <section id="formats" class="py-16 bg-gray-50">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    ...
                    <p class="text-gray-600 max-w-2xl mx-auto">Convert between various document formats with high
                        fidelity and
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
                    ...
                    <a href="docx-conversion.php"
                        ...
                        <div class="mb-4 text-indigo-600 flex justify-center">
                            <svg class="w-16 h-16 neon-blue" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p class="text-gray-600 mb-4">Microsoft Word documents with preserved formatting, images, and
                            styles.</p>
                    ...
                    <a href="html-conversion.php"
                        ...
                        <div class="mb-4 text-yellow-500 flex justify-center">
                            <svg class="w-16 h-16 neon-yellow" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M4 5.5V18.5H20V5.5H4ZM5.5 7H18.5V11.5H5.5V7ZM5.5 13H12V17H5.5V13ZM13.5 17V13H18.5V17H13.5Z"
                                    fill="currentColor" />
                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <p class="text-gray-600 mb-4">Web-ready HTML files with CSS styling for web publishing or
                            editing.</p>
                    ...
                    <a href="txt-conversion.php"
                        ...
                        <div class="mb-4 text-green-500 flex justify-center">
                            <svg class="w-16 h-16 neon-green" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M7 18H17V16H7V18Z" fill="currentColor" />
                                <path d="M17 14H7V12H17V14Z" fill="currentColor" />
                        ...
                        <p class="text-gray-600 mb-4">Simple text files for universal compatibility and easy editing.
                        </p>
                    ...
                    <a href="csv-conversion.php"
                        ...
                        <div class="mb-4 text-purple-600 flex justify-center">
                            <svg class="w-16 h-16 neon-purple" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p class="text-gray-600 mb-4">Comma-separated values for data analysis and spreadsheet
                            applications.</p>
                    ...
                    <a href="xlsx-conversion.php"
                        ...
                        <div class="mb-4 text-indigo-400 flex justify-center">
                            <svg class="w-16 h-16 neon-glow" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p class="text-gray-600 mb-4">Microsoft Excel spreadsheets with formulas, formatting, and
                            multiple sheets.
                        </p>
                    ...
                    <a href="pdf-conversion.php"
                        ...
                        <div class="mb-4 text-red-500 flex justify-center">
                            <svg class="w-16 h-16 neon-red" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M7 18H17V16H7V18Z" fill="currentColor" />
                                <path d="M17 14H7V12H17V14Z" fill="currentColor" />
                                <path d="M7 10H11V8H7V10Z" fill="currentColor" />
                        ...
                        <p class="text-gray-600 mb-4">Convert PDFs to editable formats or create PDFs from various
                            document types.
                        </p>
        ...
        <section id="features" class="py-16 features-grid">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    ...
                    <p class="text-gray-600 max-w-2xl mx-auto">We offer superior conversion quality with advanced
                        features to meet
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    ...
                    <div
                        ...
                        <p class="text-gray-600">All file conversions happen locally in your browser. Files never leave
                            your device,
                    ...
                    <div
                        ...
                        <p class="text-gray-600">Advanced algorithms ensure rapid conversions with minimal wait time,
                            even for large
                    ...
                    <div
                        ...
                        <p class="text-gray-600">Fine-tune your conversions with format-specific options to achieve
                            perfect results
                    ...
                    <div
                        ...
                        <p class="text-gray-600">Preserve formatting, fonts, images, and layouts with exceptional
                            accuracy across
                    ...
                    <div
                        ...
                        <p class="text-gray-600">Access our powerful conversion tools directly from your browser—no
                            downloads,
                    ...
                    <div
                        ...
                        <p class="text-gray-600">Convert between PDF, DOCX, HTML, TXT, CSV, and XLSX formats with
                            consistent quality
                            and reliability.</p>
                    </div>
                </div>
        ...
        <section id="how-it-works" class="py-16 bg-gradient-to-b from-white to-gray-50">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    ...
                    <p class="text-gray-600 max-w-2xl mx-auto">Convert your documents in three simple steps with our
                        intuitive
                        process.</p>
                </div>
                ...
                <div class="max-w-5xl mx-auto">
                    <div class="flex flex-col md:flex-row items-center justify-between">
                        ...
                        <div class="md:w-1/3 text-center px-6 mb-8 md:mb-0">
                            <div
                                class="bg-indigo-100 rounded-full h-20 w-20 flex items-center justify-center mx-auto mb-4">
                                <span class="text-indigo-600 font-bold text-2xl">1</span>
                            </div>
                            <h3 class="text-xl font-semibold mb-3">Upload Your File</h3>
                            <p class="text-gray-600">Drag and drop or browse to select the file you want to convert. We
                                support PDF,
                        ...
                        <div class="md:w-1/3 text-center px-6 mb-8 md:mb-0">
                            ...
                            <p class="text-gray-600">Choose your desired output format and configure any additional
                                conversion options
                        ...
                        <div class="md:w-1/3 text-center px-6">
                            ...
                            <p class="text-gray-600">Preview your converted document and download it immediately. All
                                processing
