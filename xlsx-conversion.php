        ...
        <div class="flex flex-col md:flex-row items-center">
          <div class="md:w-1/2 mb-8 md:mb-0">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight">
              Convert XLSX ↔ PDF with<br>
              <span class="text-indigo-400">Perfect Formatting</span>
            </h1>
            <p class="text-xl text-gray-300 mb-8 max-w-lg">
              Advanced XLSX and PDF conversion with font preservation, layout accuracy, and table formatting.
            </p>
          </div>
          <div class="md:w-1/2 flex justify-center">
            <div class="relative">
              <svg class="w-80 h-80 neon-glow" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <text x="38" y="27" fill="white" font-size="8" font-family="Arial, sans-serif" font-weight="bold">XLSX</text>
